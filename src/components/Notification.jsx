...
function Notification({ id, type, sender, reference, isRead, createdAt }) {
  ...
  return (
    <div
      className={`flex items-center w-full bg-white shadow-md rounded-lg p-4 my-4 ${
